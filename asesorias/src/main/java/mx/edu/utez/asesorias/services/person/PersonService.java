...
public class PersonService {
    ...
    @Transactional(readOnly = true)  //transaccion de solo lectura para que no guarde estos datos en el cache en el servidor y esten estrobando xd
    ...
    @Transactional(rollbackFor = {SQLException.class})  // haz un rollaback(que es como un commit en una transaccion), de que si hay un error SQl
